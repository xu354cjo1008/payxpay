...
<html>
    ...
    <body>
        ...
        $(document).ready(function(){
            ...
            document.getElementById('match_text').href  = "http://localhost/V1/login.php";
            document.getElementById('mypage_text').href  = "http://localhost/V1/login.php";
            document.getElementById('history_text').href  = "http://localhost/V1/login.php";    
        }    
        });
        </script>
