...
<html>
    ...
    <body>
        ...
        $(document).ready(function(){
            ...
            document.getElementById('match_text').href  = "http://frozen-dusk-3508.herokuapp.com/login.php";
            document.getElementById('mypage_text').href  = "http://frozen-dusk-3508.herokuapp.com/login.php";
            document.getElementById('history_text').href  = "http://frozen-dusk-3508.herokuapp.com/login.php";    
        }    
        });
        </script>
