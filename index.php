...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <img class="home_main" src="image/home_main.png">
            <img class="home_info1" src="image/home_info1.png">
            <img class="home_info2" src="image/home_info2.png">
            <img class="home_info3" src="image/home_info3.png">
            <img class="home_info4" src="image/home_info4.png">
            <img class="choose_home" src="image/menu_choose.png">
        ...
        $(document).ready(function(){
               ...
               document.getElementById("register").style.display='none';      
                ...
                $.ajax({
                            ...
                            success: function(response) {
                             self.location = 'http://payxpay.herokuapp.com/index.php';
                            }
                            });  
                });
                $.ajax({
            ...
            document.getElementById('match_text').href  = "http://payxpay.herokuapp.com/login.php";
            document.getElementById('mypage_text').href  = "http://payxpay.herokuapp.com/login.php";
            document.getElementById('history_text').href  = "http://payxpay.herokuapp.com/login.php";    
        }    
        });
        </script>
