    ...
    ;(function($) {
        ...
        $(function() {
            ...
            $('#invite_button').bind('click', function(e) {
                ...
                var ofriendslist_scroll = $('#friendslist_scroll');
                ofriendslist_scroll.tinyscrollbar();

                //some operation that changes the viewport content...

                ofriendslist_scroll.tinyscrollbar_update();
