    ...
    <div class="tpl_table">
      <table class="tpl_listing tpl_form" width="100%" cellpadding="0" cellspacing="0">
        <tr><form action="index.php?pg=lists&proc=del" method="post">
          <th class="first"><?php echo $PHPML_LANG["listid"]; ?></th>
          <th><?php echo $PHPML_LANG["title"]; ?></th>
          <th><?php echo $PHPML_LANG["description"]; ?></th>
          <th><?php echo $PHPML_LANG["Confirmed_hd"]; ?></th>
          <th><?php echo $PHPML_LANG["display"]; ?>?</th>
          <th><?php echo $PHPML_LANG["deleted"]; ?>?</th>
          <th colspan="3" class="last"><?php echo $PHPML_LANG["action"]; ?></th>
        </tr>
    <?php
    $intNumber = 1;
...
$pgArr['caption'] = $PHPML_LANG["mailinglists"];
